...
public class Matrix2 {
    ...
    public static void slozheniye(Matrix2 one, Matrix2 two) {
    ...
    public static void vichitaniye(Matrix2 one, Matrix2 two) {
        System.out.println("Разность матриц равна => ");
        System.out.println((one.a1 - two.a1) + "     " + (one.a2 - two.a2));
        System.out.println((one.b1 - two.b1) + "     " + (one.b2 - two.b2));
    }
    public static void nachislo(Matrix2 one) {
        Scanner in = new Scanner(System.in);
    ...
    public static void umnozheniye(Matrix2 one, Matrix2 two) {
    ...
    public static void obratnaya(Matrix2 one) {
